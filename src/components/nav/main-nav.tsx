...
export function MainNav() {
  ...
  <NavigationMenuList>
    ...
    <NavigationMenuItem>
      <NavigationMenuTrigger>Topic and Trends</NavigationMenuTrigger>
      <NavigationMenuContent>
    ...
    <NavigationMenuItem>
      <NavigationMenuTrigger>Annual Events</NavigationMenuTrigger>
      <NavigationMenuContent>
      <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
        <li>    
        <NavigationMenuLink>
    ...
    <NavigationMenuItem>
      <NavigationMenuLink href="/discover" className={navigationMenuTriggerStyle()}>
        Discover
      </NavigationMenuLink>
    </NavigationMenuItem>
